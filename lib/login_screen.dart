  ...
  Widget _buildTextField({
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        labelText: label,
        labelStyle: GoogleFonts.inter(color: colorScheme.onSurface.withOpacity(0.5), fontSize: 14.sp),
        prefixIcon: Icon(icon, color: colorScheme.onSurface.withOpacity(0.4), size: 20.sp),
        suffixIcon: isPassword
            ...
            : null,
        filled: true,
        fillColor: theme.scaffoldBackgroundColor, // Cleanest minimal contrast 
